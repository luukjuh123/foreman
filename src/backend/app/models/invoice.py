...
Customer is defined in app.models.customer and imported here for convenience.
"""
...
from app.models.customer import Customer  # noqa: F401 — re-exported for router convenience
