...
Customer is defined in app.models.customer and imported here to avoid
duplicate table definitions across the SQLAlchemy metadata.
"""
...
from app.models.customer import Customer  # noqa: F401 — re-exported for importers
