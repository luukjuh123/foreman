...
Quote numbers use the format OFF-YYYY-NNNN.
"""
...
class Quote(Base):
    """A construction quote (offerte) belonging to a single owner."""
    ...
    quote_number: Mapped[str] = mapped_column(String(25), nullable=False)
...
class QuoteLine(Base):
    ...
    unit: Mapped[str] = mapped_column(String(20), default="stuks")
