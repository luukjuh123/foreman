...
Revision ID: q1u0t3s001
Revises: w3bh00k001_webhook_system
...
revision: str = "q1u0t3s001"
down_revision: str | Sequence[str] | None = "w3bh00k001"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("quote_number", sa.String(25), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("unit", sa.String(20), server_default="stuks"),
