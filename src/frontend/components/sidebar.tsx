        ...
        <div className="flex gap-1.5">
          {actions.map(({ label, href, icon: Icon, color }) => (
            <Link
              ...
              href={href}
              onClick={onNavigate}
              className="flex flex-1 flex-col items-center gap-1.5 rounded-lg px-1 py-2.5 text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all duration-150 group"
            >
