...
describe("RegisterPage", () => {
  ...
  it("requires all fields", async () => {
    const { default: RegisterPage } = await import("@/app/(auth)/register/page");
    render(<RegisterPage />);
    expect(screen.getByLabelText(/naam/i)).toBeRequired();
...
describe("API client", () => {
  it("apiFetch is a function", async () => {
...
describe("Auth module", () => {
  it("exports login, register, logout, getAccessToken, setTokens, clearTokens, fetchCurrentUser", async () => {
    ...
    expect(typeof auth.fetchCurrentUser).toBe("function");
  });
});
