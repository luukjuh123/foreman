...
const SEARCH_ROUTES: SearchResult[] = [
  ...
  { label: "Onderaannemers", href: "/dashboard/subcontractors", section: "Pagina's" },
      ...
      <div className="flex flex-1 flex-col min-w-0">
        <header className="sticky top-0 z-30 flex h-14 items-center border-b border-border/40 bg-card/80 backdrop-blur-md px-4 md:px-6 gap-4">
          ...
          <button
            ...
            className={cn(
              "hidden md:flex items-center gap-2 rounded-lg border bg-muted/50 px-3 py-1.5 text-sm text-muted-foreground hover:bg-muted transition-colors",
              "w-56"
            )}
          >
